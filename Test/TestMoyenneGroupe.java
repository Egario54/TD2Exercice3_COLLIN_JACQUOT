...
public class TestMoyenneGroupe {
    ...
    @Test
    public void Calculer_moyenne_groupe() throws MatiereInexistanteException, MauvaiseFormation {
    ...
    @Test
    public void Calculer_moyenne_generale_groupe() throws MatiereInexistanteException, MauvaiseFormation {
        Formation f = new Formation("L3");
        f.ajouterMatiere("Maths", 6);
        f.ajouterMatiere("Physique", 4);
        f.ajouterMatiere("Chimie", 4);
